 ...
 */
class RiakMrInputKeyList extends RiakMrInput
{
    ...
    /**
     * Create a RiakMrInputBucket, input should be an array with ["bucket" => "key", "bucket2" => "key2"] or
     * ["bucket" => ["key1", "key2"]]
